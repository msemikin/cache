package ua.nure.cache.service.legacy;
...
import ua.nure.cache.dao.legacy.mysql.MysqlSrchFltrSrtDAO;
import ua.nure.cache.dao.legacy.mysql.MysqlStatisticDAO;
...
import ua.nure.cache.dao.legacy.mysql.MysqlDiagramDAO;
import ua.nure.cache.dao.legacy.mysql.MysqlIntegrConstrDAO;
import ua.nure.cache.dao.legacy.mysql.MysqlReportDAO;
import ua.nure.cache.entity.Element;
import ua.nure.cache.entity.legacy.Resp;
import ua.nure.cache.service.legacy.contract.IServer;
...
public class Server implements IServer {
	...
	public void insertObject(HttpServletRequest req, HttpServletResponse resp)
		...
		Element jsonJavaRootObject = new Gson().fromJson(line, Element.class);
	...
	public void insertSrchFltSrt(String whichType, HttpServletRequest req,
		...
		InformationalRequirement stat = new Gson().fromJson(line, InformationalRequirement.class);
	...
	public void insertAlgDeps(HttpServletRequest req, HttpServletResponse resp)
		...
		AlgDep deps = new Gson().fromJson(line, AlgDep.class);
	...
	public void insertLinkConstr(HttpServletRequest req,
			HttpServletResponse resp) throws IOException {
		String line = req.getParameter("constraint");
		LinkConstraint deps = new Gson().fromJson(line, LinkConstraint.class);
	...
	public void findLinkConstr(HttpServletRequest req, HttpServletResponse resp)
			throws IOException {
		String line = req.getParameter("projectId");
		List<LinkConstraint> result = new MysqlIntegrConstrDAO()
