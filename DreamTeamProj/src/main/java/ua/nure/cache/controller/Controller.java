...
import ua.nure.cache.constants.DiagrTypes;
import ua.nure.cache.service.legacy.Server;
		...
		try {
			...
			methods.put("/algorithmic_dependencies/new", cardManager
					.getDeclaredMethod("insertAlgDeps",
							request, response)); 
			methods.put("/algorithmic_dependencies/sourceFields/insert", cardManager
					.getDeclaredMethod("insertSourceField",
							request, response)); 
			...
			methods.put("/account/register", cardManager.getDeclaredMethod(
					"registerStudent", request, response));

			methods.put("/account/login", cardManager.getDeclaredMethod(
