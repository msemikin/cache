...
app.controller("ERCtrl", ['$scope', 'Diagram', function($scope, Diagram) {
    ...
    // dragAndDrop('.entity', '.er-model', undefined, graph, 'Entity');
    // dragAndDrop('.attribute', '.er-model', undefined, graph, 'Attribute');
    // dragAndDrop('.association', '.er-model', undefined, graph, 'Association');
    //
