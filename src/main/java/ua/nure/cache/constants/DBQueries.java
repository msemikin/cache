package ua.nure.cache.constants;
...
public class DBQueries {
	...
	public static final String INSERT_STUDENT = "INSERT INTO `my_db`.`student`"
			+ "(`fullname`, `email`, `password`)"
			+ "VALUES(?, ?, ?)";
	
	public static final String GET_STUDENT_BY_EMAIL = "SELECT id, fullname, email"
			+ "FROM student"
			+ "WHERE email LIKE ?";
